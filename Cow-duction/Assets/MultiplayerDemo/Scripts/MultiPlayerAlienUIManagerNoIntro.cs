...
public class MultiPlayerAlienUIManagerNoIntro : MonoBehaviour
{
    // Private variables
    ...
    void Update()
    {
        ...
        */
        ...
        speedText.text = _rbUFO.velocity.magnitude.ToString("F0");
        altitudeText.text = (_rbUFO.transform.position.y - 13f).ToString("F0");
    ...
    public void IncreaseScore(float milk) //, GameObject cow
    {
        ...
        int cowScore = 1;
        /*
        if (cow.GetComponent<MultiPlayerCowBrain>().cowType == "Normal")
        {
            cowScore = 1;
        }
        else if (cow.GetComponent<MultiPlayerCowBrain>().cowType == "Chocolate Cow")
        {
            cowScore = 2;
        }
        else if (cow.GetComponent<MultiPlayerCowBrain>().cowType == "Strawberry Cow")
        {
            cowScore = 3;
        }
        */
    ...
    public void SetParameter(string name, float value)
    {
        switch (name)
        {
            case "HorizontalSpeedSlider":
                _rbUFO.GetComponent<MultiPlayerSpaceshipController>().horizontal = value;
                break;
            case "VerticalSpeedSlider":
                _rbUFO.GetComponent<MultiPlayerSpaceshipController>().vertical = value;
                break;
            case "MaxHeightSlider":
                _rbUFO.GetComponent<MultiPlayerSpaceshipController>().maxHeight = value;
                break;
            case "MinHeightSlider":
                _rbUFO.GetComponent<MultiPlayerSpaceshipController>().minHeight = value;
                break;
            /*case "RotationForceSlider":
                _rbUFO.GetComponent<MultiPlayerSpaceshipController>().rotationForce = value;
                break;*/
            ...
            case "MaxRotationSlider":
                _rbUFO.GetComponent<MultiPlayerSpaceshipController>().maxRotation = value;
                break;
            ...
            case "CaptureSpeedSlider":
                _rbUFO.GetComponent<MultiPlayerCowAbduction>().captureSpeed = value;
                break;
            case "MaxCaptureLengthSlider":
                _rbUFO.GetComponent<MultiPlayerCowAbduction>().maxCaptureLength = value;
                break;
            /*case "NumberOfJointsSlider":
                _rbUFO.GetComponent<MultiPlayerCowAbduction>().numberOfJoints = (int)value;
                break;*/
            case "GrappleTimeSlider":
                _rbUFO.GetComponent<MultiPlayerCowAbduction>().grappleTime = value;
                break;
            ...
            case "MaxCowAmountSlider":
                CowSpawner.GetComponent<MultiPlayerCowSpawner>().maxCowAmount = (int)value;
                break;
            case "CowSpawnRateSlider":
                CowSpawner.GetComponent<MultiPlayerCowSpawner>().spawnRate = (int)value;
                break;
